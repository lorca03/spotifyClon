import { usePlayerStore } from "@/store/playerStrore";
...
const VolumeControl = () => {
  ...
  return (
    <div className="flex justify-center gap-x-2 text-white">
      <button className="opacity-70 transition hover:opacity-100" onClick={handleClickVolume}>
...
const CurrentSong = ({ image, title, artists }) => {
  return (
    <div className="flex items-center gap-4 relative overflow-hidden">
      <picture class="aspect-square w-14 bg-[#121212] h-14 rounded-md overflow-hidden">
...
export function Player() {
  ...
  return (
    <div className="flex flex-row justify-between w-full pt-2 px-3 z-50">
